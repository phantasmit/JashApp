...
const CustomerPortalSelectionView = (props) => {
    return (
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ flexGrow: 1, alignItems: "center", padding: 10, paddingBottom: 80 }}>
...
const ProductPortalSelectionView = (props) => {
    ...
    return (
        <FlatList
            ...
            contentContainerStyle={{ flexGrow: 1, paddingBottom: 80, marginTop: 15, alignItems: "center" }}
